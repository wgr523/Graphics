...
//		Base co = new Complex(new Point(), 1, "block.obj", 0,.9,0);
//		Line tmpline = new Line(new Point(-10,0,10), 1,0,0);
////		System.out.println( co.intersect(tmpline) );
//		T_Point_Obj_Normal oo = co.intersect_Everyone(tmpline);
//		//treee.getIntersect(tmpline);
